...
//                }
    ...
    public Object visitar(NoDeclaracaoRegistro noDeclaracaoRegistro) throws ExcecaoVisitaASA {
        ...
        //VERIFICANDO SE O REGISTRO J�? FOI DECLARADO
        ...
        //VERIFICANDO SE ALGUM ATRIBUTO DO REGISTRO EST�o DUPLICADO
        for (NoListaAtributos atributo : atributos) {
            for(NoAtributo simbolo : atributo.getDeclaracoes()) {
                //verifica se o atributo é duplicado
    ...
    public Object visitar(NoInicializacaoAtributoVariavel inicializacao) throws ExcecaoVisitaASA {
        ...
        //VERIFICANDO SE EXISTE A INST�NCIA EM MEMORIA
        ...
        for (NoListaAtributos atributo : atributos) {
            for(NoAtributo s : atributo.getDeclaracoes()) {
                ...
                //VERIFICANDO EXIST�NCIA DO CAMPO NA LISTA DE CAMPOS DO REGISTRO
